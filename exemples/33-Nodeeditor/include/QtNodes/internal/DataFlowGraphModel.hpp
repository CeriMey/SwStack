...
public:
    DataFlowGraphModel(const QString &context, std::shared_ptr<NodeDelegateModelRegistry> registry);
...
public:
    ...
    Q_INVOKABLE bool setPortData(NodeId nodeId,
                     PortType portType,
                     PortIndex portIndex,
...
public slots:
    void resumeDebug(NodeId const nodeId);
...
private:
    ...
    QString _nodesContext;

    QList<DebugFlowManager *> _debugFlowManagerList;
